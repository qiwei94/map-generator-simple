"""Generate Object 1 (Water Plate) for Chicago - full cache data."""
...
# Chicago full area (matching cache extent)
LAT1, LON1 = 41.80, -87.75   # south-west
LAT2, LON2 = 42.00, -87.55   # north-east
CITY_NAME = "chicago"
OUTPUT_DIR = "output/chicago"

print("=" * 70)
print("  Chicago Object 1: Water Plate (Full Cache Data)")
print("=" * 70)
...
# =====================================================================
# Stage 1: Water features (from cache)
# =====================================================================
print(f"\n[Stage 1] Fetching water data (from cache)...")
t1 = time.time()
...
# =====================================================================
print(f"\n{'=' * 70}")
print(f"  Chicago Object 1 Generation Complete")
print(f"{'=' * 70}")
