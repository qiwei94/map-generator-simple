...
_FULL_STAGES = (
    ...
    ("[Stage 4.6]", 70, "正在准备可打印水体与诊断图"),
    ("[preprocess] Total:", 68, "道路、水体与街区预处理已经完成"),
    ("[preprocess] _compute_block_base:", 66, "正在切分城市街区"),
    ("[preprocess] subtraction+filter:", 64, "正在清理图层重叠与细碎结构"),
    ("[preprocess] road_continuity:", 63, "正在恢复道路骨架连续性"),
