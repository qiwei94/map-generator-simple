"""Generate standalone water-only 3MF for Hangzhou West Lake area.

Usage:
    cd /path/to/map_generator_final
    python generate_water_hangzhou.py

Output:
    output/water_only/hangzhou_west_lake_water.3mf
"""
...
# =====================================================================
# West Lake (西湖), Hangzhou — 25km × 25km bounding box
# =====================================================================
# Center: ~30.25°N, 120.15°E
# At 30°N: 1° lat ≈ 111km, 1° lon ≈ 96km
# Δlat ≈ 25/111 ≈ 0.225°,  Δlon ≈ 25/96 ≈ 0.260°
...
print("=" * 60)
print("  Water-only 3MF — Hangzhou West Lake")
print("=" * 60)
...
# Water-only 3MF: put mesh in "water" slot → extruder 3, WATER_COLOR (#3C96DC)
meshes = {
