...
parser = argparse.ArgumentParser(
    description="使用 osmium CLI 管线生成芝加哥 3MF 模型"
)
parser.add_argument(
    '--elevation-file',
    type=str,
...
# PBF 文件
PBF_FILE = os.path.join(_project_root, 'pbf_cache', 'illinois-latest.osm.pbf')
